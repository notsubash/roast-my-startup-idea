        ...
        result = graph.invoke(
            {
                ...
                "verdicts": [
                    {"judge": "vc", "verdict": "FAIL", "roast": "Weak moat.", "score": 3, "key_concern": "No defensibility."},
                    {"judge": "engineer", "verdict": "CONDITIONAL", "roast": "Feasible but brittle.", "score": 5, "key_concern": "Extraction reliability."},
                    {"judge": "pm", "verdict": "FAIL", "roast": "Unclear habit.", "score": 3, "key_concern": "Low user urgency."},
                    {"judge": "customer", "verdict": "FAIL", "roast": "I would ignore it.", "score": 2, "key_concern": "Too much friction."},
                    {"judge": "competitor", "verdict": "FAIL", "roast": "Easy to copy.", "score": 2, "key_concern": "Incumbents can bundle it."},
                ],
                "messages": [],
                "round": 1,
                "max_rounds": 2,
